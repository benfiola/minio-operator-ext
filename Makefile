...
RESOURCES_MANIFEST_SRC = $(MANIFESTS)/crds.yaml
...
apply-manifests: $(CRDS_MANIFEST) $(KUBECTL) $(MINIO_OPERATOR_MANIFEST) $(MINIO_TENANT_MANIFEST) $(OPENLDAP_MANIFEST) $(RESOURCES_MANIFEST)
...
generate-manifests: $(CRDS_MANIFEST) $(MINIO_OPERATOR_MANIFEST) $(MINIO_TENANT_MANIFEST) $(OPENLDAP_MANIFEST) $(RESOURCES_MANIFEST)
...
$(RESOURCES_MANIFEST): | $(ASSETS)
	# copy resources manifest
	cp $(RESOURCES_MANIFEST_SRC) $(RESOURCES_MANIFEST)
